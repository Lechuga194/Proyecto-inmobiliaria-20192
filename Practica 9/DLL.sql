/*
	DDL.SQL Practica 9 | Lechuga Martínez José Eduardo
*/
...
CREATE TABLE encargado
  (
    ...
    nombrepila     VARCHAR2(500) NOT NULL,
    apaterno       VARCHAR2(500) NOT NULL,
    amaterno       VARCHAR2(500) NOT NULL,
    fnacimiento    DATE         NOT NULL,
    fregistro      DATE DEFAULT sysdate NOT NULL,
    colonia        VARCHAR2(500) NOT NULL,
    numerovivienda CHAR(3)      NOT NULL,
    estado         VARCHAR2(500) NOT NULL,
    calle          VARCHAR2(500) NOT NULL,
    CONSTRAINT check_num_enc    CHECK (regexp_like(numerovivienda, '^[0-9]')),
...
CREATE TABLE gerente
  (
    ...
    estado         VARCHAR2(500) NOT NULL,
    calle          VARCHAR2(500) NOT NULL,
    CONSTRAINT check_num_ger    CHECK (regexp_like(numerovivienda, '^[0-9]')),
...
CREATE TABLE empleado
  (
    ...
    estado         VARCHAR2(500) NOT NULL,
    calle          VARCHAR2(500) NOT NULL,
    CONSTRAINT check_num_emp    CHECK (regexp_like(numerovivienda, '^[0-9]')),
...
CREATE TABLE sucursal
  (
    ...
    nombresucursal VARCHAR2(500) NOT NULL,
...
CREATE TABLE cliente
  (
    ...
    estado         VARCHAR2(500) NOT NULL,
    calle          VARCHAR2(500) NOT NULL,
    CONSTRAINT check_num_cl    CHECK (regexp_like(numerovivienda, '^[0-9]')),
...
ALTER TABLE tarjeta DROP COLUMN totalpesos;
...
ALTER TABLE compra DROP COLUMN horacompra;

CREATE TABLE forma_pago
  (
    formapago VARCHAR2(500),
    idcompra  NUMBER,
    CONSTRAINT forma_pago_idcompra_FK FOREIGN KEY (idcompra) REFERENCES compra (idcompra)
  );
ALTER TABLE forma_pago ADD CONSTRAINT forma_pago_PK PRIMARY KEY (formapago, idcompra);
...
CREATE TABLE producto_med_controlado
  (
    ...
    laboratorio    VARCHAR2(500) NOT NULL,
    compuesto      VARCHAR2(500) NOT NULL,
    dosis          VARCHAR2(500) NOT NULL,
    cantidadneta   VARCHAR2(500) NOT NULL,
    precio         NUMBER NOT NULL,
    cantidad       VARCHAR2(500) NOT NULL,
    marca          VARCHAR2(500) NOT NULL,
...
ALTER TABLE producto_med_controlado DROP COLUMN idcompra;
ALTER TABLE producto_med_controlado DROP COLUMN departamento;
...
CREATE TABLE producto_med_libre
  (
    ...
    marca          VARCHAR2(500) NOT NULL,
    presentacion   VARCHAR2(500) NOT NULL,
    departamento   VARCHAR2(500) NOT NULL,
    tipoproducto   VARCHAR2(500) NOT NULL,
    refrigeracion  VARCHAR2(2) NOT NULL,
    felaboracion   DATE NOT NULL,
    fcaducidad     DATE NOT NULL,
...
--Modificacion de la tabla para la practica 7 (Quitamos idcompra y su respectivo constraint)
ALTER TABLE producto_med_libre DROP COLUMN idcompra;
ALTER TABLE producto_med_libre DROP COLUMN departamento;
...
--Modificacion de la tabla para la practica 7 (Quitamos idcompra y su respectivo constraint)
ALTER TABLE producto_abarrote DROP COLUMN idcompra;
ALTER TABLE producto_abarrote DROP COLUMN departamento;
...
--Modificacion de la tabla para la practica 7 (Quitamos idcompra y su respectivo constraint)
ALTER TABLE producto_vino DROP COLUMN idcompra;
ALTER TABLE producto_vino DROP COLUMN departamento;
