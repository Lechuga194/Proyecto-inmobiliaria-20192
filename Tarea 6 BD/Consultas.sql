...
WHERE EXTRACT(DAY FROM MEDICO_CONSULTAR_PACIENTE.FECHA_CONSULTA) = EXTRACT(DAY FROM PACIENTE.FNACIMIENTO)
AND EXTRACT(MONTH FROM MEDICO_CONSULTAR_PACIENTE.FECHA_CONSULTA) = EXTRACT(MONTH FROM PACIENTE.FNACIMIENTO);
...
SELECT MEDICO.IDMEDICO,
  MEDICO.NOMBRE,
  COUNT(MEDICO_CONSULTAR_PACIENTE.IDMEDICO) AS TOTAL_CONSULTAS,
...
WHERE PACIENTE.ESTADO   = 'Puebla'
AND PACIENTE.APATERNO   = 'Yockley';
...
JOIN ESPECIALIDAD
ON (MEDICO_TENER_ESPECIALIDAD.IDESPECIALIDAD = ESPECIALIDAD.IDESPECIALIDAD)
WHERE MEDICO_INGRESAR_PACIENTE.FECHA_INGRESO BETWEEN CURRENT_DATE-7 AND CURRENT_DATE
GROUP BY ESPECIALIDAD.NOMBRE_ESPECIALIDAD,
  PACIENTE.NOMBRE,
  PACIENTE.APATERNO,
  PACIENTE.AMATERNO
...
/*
Esto considerando que si un mismo paciente entra n veces al hospital
solo cuenta como 1 (Si se requiere lo contrario basta con retirar DISTINCT)
*/
SELECT HABITACION,
  SUM(
  CASE
    WHEN FECHA_INGRESO BETWEEN '01/01/17' AND '31/12/17'
    THEN 1
    ELSE 0
  END) AS A2017,
  SUM(
  CASE
    WHEN FECHA_INGRESO BETWEEN '01/01/18' AND '31/12/18'
    THEN 1
    ELSE 0
  END) AS A2018,
  SUM(
  CASE
    WHEN FECHA_INGRESO BETWEEN '01/01/19' AND '31/12/19'
    THEN 1
    ELSE 0
  END) AS A2019,
  SUM(
  CASE
    WHEN ESPECIALIDAD.IDESPECIALIDAD = 1
    THEN 1
    ELSE 0
  END) AS INMUNOLOGIA,
  SUM(
  CASE
    WHEN ESPECIALIDAD.IDESPECIALIDAD = 2
    THEN 1
    ELSE 0
  END) AS NEUROLOGIA,
  SUM(
  CASE
    WHEN ESPECIALIDAD.IDESPECIALIDAD = 3
    THEN 1
    ELSE 0
  END) AS CIRUGIA_TORACICA,
  SUM(
  CASE
    WHEN ESPECIALIDAD.IDESPECIALIDAD = 4
    THEN 1
    ELSE 0
  END) AS CIRUGIA_PEDIATRICA,
  SUM(
  CASE
    WHEN ESPECIALIDAD.IDESPECIALIDAD = 5
    THEN 1
    ELSE 0
  END)                       AS ANGIOLOGIA,
  COUNT(DISTINCT IDPACIENTE) AS TOTAL_PACIENTES --RETIRAR DISTINCT AQUI
FROM MEDICO_INGRESAR_PACIENTE
JOIN MEDICO_TENER_ESPECIALIDAD
ON(MEDICO_INGRESAR_PACIENTE.IDMEDICO = MEDICO_TENER_ESPECIALIDAD.IDMEDICO)
JOIN ESPECIALIDAD
...
SELECT SUM(
  ...
  CASE
    ...
    ELSE 0
  END)                                        AS ANGIOLOGIA,
  COUNT(MEDICO_CONSULTAR_PACIENTE.IDPACIENTE) AS TOTAL_PACIENTES
FROM MEDICO_CONSULTAR_PACIENTE
JOIN MEDICO_TENER_ESPECIALIDAD
ON(MEDICO_CONSULTAR_PACIENTE.IDMEDICO = MEDICO_TENER_ESPECIALIDAD.IDMEDICO)
JOIN ESPECIALIDAD
...
JOIN PACIENTE
ON(MEDICO_CONSULTAR_PACIENTE.IDPACIENTE = PACIENTE.IDPACIENTE)
GROUP BY FLOOR(months_between(CURRENT_DATE,PACIENTE.FNACIMIENTO)/12)
HAVING FLOOR(months_between(CURRENT_DATE,PACIENTE.FNACIMIENTO)  /12) BETWEEN 30 AND 35;
...
SELECT NOMBRE,
  APATERNO,
  AMATERNO,
  COUNT(MEDICO_INGRESAR_PACIENTE.IDPACIENTE) AS TOTAL_CONSULTAS,
  AVG(IDMEDICO) AS PROMEDIO
FROM MEDICO_INGRESAR_PACIENTE
JOIN PACIENTE
ON(MEDICO_INGRESAR_PACIENTE.IDPACIENTE = PACIENTE.IDPACIENTE)
GROUP BY NOMBRE,
  APATERNO,
  AMATERNO
HAVING AVG(MEDICO_INGRESAR_PACIENTE.IDPACIENTE) > COUNT(MEDICO_INGRESAR_PACIENTE.IDPACIENTE);
...
SELECT SUM(
  ...
  SUM(
  CASE
    WHEN p.ESTADO = 'Monterrey'
    THEN 1
    ELSE 0
  END) AS MTY,
  SUM(
  CASE
    WHEN p.ESTADO = 'Guadalajara'
    THEN 1
    ELSE 0
  END) AS GDL,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/01/17' AND '31/12/17'
    THEN 1
    ELSE 0
  END) AS A_2017,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/01/18' AND '31/12/18'
    THEN 1
    ELSE 0
  END) AS A_2018,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/01/19' AND '31/12/19'
    THEN 1
    ELSE 0
  END) AS A_2019,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/01/17' AND '01/04/17'
    THEN 1
    ELSE 0
  END) AS T1_2017,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/04/17' AND '01/07/17'
    THEN 1
    ELSE 0
  END) AS T2_2017,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/07/17' AND '01/10/17'
    THEN 1
    ELSE 0
  END) AS T3_2017,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/10/17' AND '01/1/18'
    THEN 1
    ELSE 0
  END) AS T4_2017,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/01/18' AND '01/04/18'
    THEN 1
    ELSE 0
  END) AS T1_2018,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/04/18' AND '01/07/18'
    THEN 1
    ELSE 0
  END) AS T2_2018,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/07/18' AND '01/10/18'
    THEN 1
    ELSE 0
  END) AS T3_2018,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/10/18' AND '01/1/19'
    THEN 1
    ELSE 0
  END) AS T4_2018,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/01/19' AND '01/04/19'
    THEN 1
    ELSE 0
  END) AS T1_2019,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/04/19' AND '01/07/19'
    THEN 1
    ELSE 0
  END) AS T2_2019,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/07/19' AND '01/10/19'
    THEN 1
    ELSE 0
  END) AS T3_2019,
  SUM(
  CASE
    WHEN m.FECHA_INGRESO BETWEEN '01/10/19' AND '01/1/20'
    THEN 1
    ELSE 0
  END)                AS T4_2019,
  COUNT(m.IDPACIENTE) AS TOTAL
FROM MEDICO_INGRESAR_PACIENTE m
JOIN PACIENTE p
